...
class CinemaProgram_Model_Detail extends Model_PDO {
   ...
   public function getTimesWithMovies(DateTime $dateFrom, DateTime $dateTo) {
      $dbc = new Db_PDO();
...
//      $dbst->bindValue(':idcat', (int)$idCat, PDO::PARAM_INT);
   ...
   public function saveMovie($name, $label, $price, $length, $version,
           ...
           $access = 0, $imdbid = null, $csfdid = null, $image = null, $critique = null, $id = null) {
      $dbc = new Db_PDO();
      ...
      if($id !== null) {
         $dbst = $dbc->prepare("UPDATE ".Db_PDO::table(self::DB_TABLE)
          ...
          ." `".self::COL_IMAGE."` = :image, `".self::COL_CRITIQUE."` = :critique"
          ." WHERE ".self::COL_ID." = :idmovie");
         ...
         $dbst = $dbc->prepare("INSERT INTO ".Db_PDO::table(self::DB_TABLE)
                 ...
                 " :vers, :imdbid, :csfdid, :img, :critique)");
