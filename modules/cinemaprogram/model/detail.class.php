 ...
 */
   ...
   const COL_T_DATEFROM = 'date_from';
   const COL_T_DATETO = 'date_to';
...
//         $dbst->bindValue(':change', time(), PDO::PARAM_INT);
   ...
   public function saveMovieTime($idMovie, $dateFrom, $time, $dateTo = null, $id = null) {
      $dbc = new Db_PDO();
...
//         return $dbst->execute();
         ...
         $dbst = $dbc->prepare("INSERT INTO ".Db_PDO::table(self::DB_TABLE_TIME)
             ."  (`".self::COL_T_ID_M."`,`".self::COL_T_DATEFROM."`, `".self::COL_T_DATETO."`, `"
             .self::COL_T_TIME."`)"
             ." VALUES (:idmovie, :datefrom, :dateto, :mtime)");

         $dbst->bindValue(':idmovie', $idMovie, PDO::PARAM_INT);
         $dbst->bindValue(':datefrom', $dateFrom, PDO::PARAM_STR);
         $dbst->bindValue(':dateto', $dateTo, PDO::PARAM_STR);
         $dbst->bindValue(':mtime', $time, PDO::PARAM_STR);
