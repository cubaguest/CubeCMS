...
//                 AND $_SESSION[$sessionName]['source'] == $source) {
         ...
         $this->view()->start = $scrollComponent->getConfig(Component_Scroll::CONFIG_START_RECORD);
         $this->view()->stop = $this->view()->start + $scrollComponent->getConfig(Component_Scroll::CONFIG_RECORDS_ON_PAGE);
