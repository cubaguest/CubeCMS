...
CHANGE COLUMN `name_cs` `action_name_cs` VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_czech_ci' NOT NULL , 
...
CHANGE COLUMN `name_sk` `action_name_sk` VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_slovak_ci' NOT NULL  , 
...
CHANGE COLUMN `name_en` `action_name_en` VARCHAR(50) NULL DEFAULT NULL  , 
...
CHANGE COLUMN `name_de` `action_name_de` VARCHAR(50) NULL DEFAULT NULL  , 
...
CHANGE COLUMN `changed` `action_changed` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  , 
