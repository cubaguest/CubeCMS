...
//		Načtení stránky z url
		...
		$this->progresLink = (string)$this->getLinks(true).AppCore::SPECIALITEMS_DIR.Links::COOL_URL_SEPARATOR.self::PROGRESS_DIR.Links::COOL_URL_SEPARATOR.self::PROGRESS_FILE;
