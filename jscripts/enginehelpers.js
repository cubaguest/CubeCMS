...
/* DEPRECATED */
function vveShowMessages(dataObj){ CubeCMS.Mgs.show(dataObj);}
function infoMsg(msg, clear){ CubeCMS.Mgs.info(msg, clear); }
function clearInfoMsg(){ CubeCMS.Mgs.clear('info'); }
function clearErrMsg(){ CubeCMS.Mgs.clear('error'); }
function errMsg(msg, clear){ CubeCMS.Mgs.err(msg, clear); }
