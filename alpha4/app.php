...
//		$mainTpl->assign("MAIN_ROOT_DIR", $links->getMainWebDir());
		...
		Template::addMainVar("NOT_LOGIN_USER_NAME",_("Nepřihlášen"));
		Template::addMainVar("LOGIN_USER_NAME",_("Přihlášen"));
		Template::addMainVar("USER_LOGIN_USERNAME", $this->auth->getUserName());
...
//		$this->template->assign("COUNT_ALL_SQL_QUERY", $mysql->getCountAllSqlQuery());
		Template::addMainVar("COUNT_ALL_SQL_QUERY", Db::getCountQueries());
...
//			$this->template->append($key, $value);
		}
...
//				odstranění proměných
	...
	public function selectCategory() {
		...
		Template::addMainVar("MAIN_CATEGORY_TITLE", $this->category->getLabel());
