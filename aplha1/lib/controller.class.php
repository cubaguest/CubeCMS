...
//	private $link = null;
	 ...
	 */
	function __construct(Module $module, Config $config, Db $db, ModuleAction $action, Rights $rights, Messages &$messages, Messages &$errors) {
			/**
		...
		function __autoload($className){
			...
			//je načítán e-plugin
			else if(file_exists('.' . DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR. 'EPlugins' . DIRECTORY_SEPARATOR . $className . '.class.php')) {
				require_once ('.' . DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR. 'EPlugins' . DIRECTORY_SEPARATOR . $className . '.class.php');
			}else {
