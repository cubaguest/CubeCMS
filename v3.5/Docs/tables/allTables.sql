...
--
-- Počítač: localhost
-- Vygenerováno: Pátek 28. listopadu 2008, 15:22
-- Verze MySQL: 5.0.60
...
INSERT INTO `vypecky_blogs` (`id_blog`, `id_section`, `key`, `label_cs`, `text_cs`, `label_en`, `text_en`, `label_de`, `text_de`, `time`, `id_user`, `deleted`, `deleted_by_id_user`) VALUES
...
INSERT INTO `vypecky_items` (`id_item`, `label_cs`, `alt_cs`, `label_en`, `alt_en`, `label_de`, `alt_de`, `group_admin`, `group_user`, `group_guest`, `group_poweruser`, `scroll`, `comments`, `ratings`, `priority`, `id_category`, `id_module`) VALUES
(1, 'Tlačenka', 'Tlačenka aneb blog na Výpečkách', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 10, 1, 1, 0, 10, 11),
(2, 'Výpečky', 'Naše logo', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 5, 1, 12),
(3, 'Portfolio', 'Portfolio našeho grafika', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 0, 2, 12),
(4, 'Fotogalerie', 'Fotografie z akcí', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 10, 1, 0, 0, 11, 8),
(5, 'Jitrničky', 'Jitrničky aneb novinky na výpečkách', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 4, 1, 0, 0, 13, 2),
(6, 'Komiks', 'Komiks Kuba a Kuba', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 1, 0, 1, 0, 3, 13),
(7, 'Úvodní proslov', 'Úvodní slovo ke komiksům', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 5, 3, 1),
(8, 'Odkazy', 'Odkazy', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 0, 0, 0, 0, 12, 14),
(9, 'Odkazy', NULL, NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 0, 12, 1),
(10, 'Jak žije Blahoš', 'Jak si žije Server Blahoš u nás ve sklepě', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 0, 8, 10),
(11, 'O Blahošovi', 'Úvodní text o Blahošovi', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 5, 8, 1),
(12, 'WebMail Výpeček', 'Přístup k Webmailovému klientu Výpeček', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 0, 7, 10),
(13, 'Sdílená data', 'Sdílená data pro potřeby Výpeček', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', 0, 0, 0, 0, 6, 10),
(14, 'Naše Data', 'Úvodní slovo ke zdíleným datů', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 0, 0, 0, 0, 6, 1),
(15, 'Kniha návštěv', 'Kniha návštěv - nebojte se a napište nám', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 10, 0, 0, 0, 9, 9),
(16, 'Chyby enginu', 'Chyby a opravy v Enginu Výpeček', NULL, NULL, NULL, NULL, 'rwc', 'rw-', '---', 'rwc', 0, 0, 0, 0, 14, 15),
(17, 'Můj účet', 'Nastavení mého účtu', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 0, 0, 0, 0, 4, 4),
(18, 'Sponzoři', 'Naši sponzoři', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 0, 0, 0, 0, 15, 16),
(19, 'Uživatelé', 'Uživatelé na portálu', NULL, NULL, NULL, NULL, 'rwc', 'r--', '---', 'rwc', 20, 0, 0, 0, 16, 17);
...
(6, 11, '<p>Tak tady žije blahoš. Náš server, který je schován ve sklepě a tiše tu šlape už dva roky. Ani se radši neptejte co je to za stroj. Je to Pentuin2 350Mhz s 384 MB RAM. To koukáte co? No jo stačí <a title="Gentoo linux" href="http://www.getoo.org" target="_blank">Gentoo linux</a>, správné nastavení je je to. :-) <img style="float: left;" title="10720-stamp.jpg" src="data/userimages/10720-stamp.jpg" alt="10720-stamp.jpg" width="160" height="128" /><img style="float: right;" title="gentoo-logo.jpg" src="data/userimages/gentoo-logo.jpg" alt="gentoo-logo.jpg" width="150" height="150" /></p>', 1226622735, '<p>Blahos is our server, whitch hosting domain vypecky.info and other. Have fun!</p>', NULL);
...
(27, 11, 11, 3, 'mozillaps', 522426, 1222599842),
