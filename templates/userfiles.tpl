...
<div class="userFiles">
   ...
   <form method="post" action="{$VARS.AJAX_ADD_FILE_LINK}" enctype="multipart/form-data" onsubmit="sendUserFile();">
   ...
   <script type="text/javascript">
      function sendUserFile(){
         $.ajax({
            type: "POST",
            url: "{/literal}{$VARS.AJAX_ADD_FILE_LINK}{literal}",
            data: "userfiles_new_file",
