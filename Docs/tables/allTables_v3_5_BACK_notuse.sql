...
--
-- Počítač: localhost
-- Vygenerováno: Neděle 15. března 2009, 16:56
-- Verze MySQL: 5.0.70
...
--
-- Struktura tabulky `vypecky_blogs`
--

CREATE TABLE IF NOT EXISTS `vypecky_blogs` (
...
CREATE TABLE IF NOT EXISTS `vypecky_blogs_sections` (
  ...
  `deleted` tinyint(1) NOT NULL default '0',
  `deleted_by_id_user` smallint(5) unsigned default NULL,
  PRIMARY KEY  (`id_section`),
  KEY `id_item` (`id_item`,`urlkey`,`id_user`,`deleted_by_id_user`),
  FULLTEXT KEY `label_cs` (`label_cs`,`label_en`,`label_de`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- Vypisuji data pro tabulku `vypecky_blogs_sections`
--

INSERT INTO `vypecky_blogs_sections` (`id_section`, `id_item`, `urlkey`, `label_cs`, `label_en`, `label_de`, `time`, `id_user`, `deleted`, `deleted_by_id_user`) VALUES
(1, 1, 'nezarazeno', 'Nezařazeno', NULL, NULL, 1222278463, 3, 0, NULL);
...
(1, 2, 'vypecky', 'Výpečky', 'Vepřové výpečky', NULL, NULL, NULL, NULL, '', 0, 10, 1, 1, 1, 'yearly', 0.1, 1, 0),
(2, 2, 'portfolio', 'Portfolio', 'Naše portfolio', NULL, NULL, NULL, NULL, '', 0, 9, 1, 0, 1, 'yearly', 0.1, 1, 0),
(3, 12, 'komiks', 'Komiks', 'Komiks Kuba a Kuba', 'Comics', 'Comics Kuba and Kuba', NULL, NULL, NULL, 0, 5, 1, 0, 0, 'yearly', 0.1, 1, 0),
(4, 11, 'ucet', 'Účet', 'Účet na výpečkách', 'Account', 'Account on vypecky', NULL, NULL, NULL, 0, 5, 1, 1, 1, 'yearly', 0.1, 1, 0),
(5, 1, 'forum', 'Fórum Výpeček', 'iframe', NULL, NULL, NULL, NULL, 'id=1', 0, 4, 0, 0, 0, 'yearly', 0.1, 1, 0),
(6, 7, 'sdilena-data', 'Sdílená data', 'Sdílená data pro potřeby obyvatelů výpeček', NULL, NULL, NULL, NULL, '', 0, 1, 1, 1, 1, 'yearly', 0.1, 1, 0),
(7, 6, 'email', 'Email', 'Přístup k výpečkovskému Mailu', NULL, NULL, NULL, NULL, '', 0, 1, 1, 0, 0, 'yearly', 0.1, 1, 0),
(8, 6, 'jak-zije-blahos', 'Jak žije Blahoš', 'Statistiky o Blahošovi', NULL, NULL, NULL, NULL, '', 0, 1, 1, 0, 0, 'yearly', 0.1, 1, 0),
(9, 8, 'kniha-navstev', 'Kniha návštěv', 'Napište nám', 'Guestbook', 'Our guestbook', NULL, NULL, NULL, 0, 1, 1, 1, 1, 'yearly', 0.1, 1, 0),
(10, 1, 'tlacenka', 'Tlačenka', 'Tlačenka aneb Blog na výpečkách', NULL, NULL, NULL, NULL, '', 0, 11, 1, 1, 1, 'yearly', 0.1, 1, 0),
(11, 3, 'fotogalerka', 'Fotogalerka', 'Fotogalerie z akcí a tak', NULL, NULL, NULL, NULL, '', 0, 5, 1, 1, 1, 'weekly', 0.5, 1, 0),
(12, 5, 'odkazy', 'Odkazy', 'Odkazy na zajímavé stránky', 'Links', 'Links to interesting web pages', NULL, NULL, 'sectiontable=links_section', 0, 5, 1, 1, 1, 'yearly', 0.1, 1, 0),
(13, 4, 'jitrnicky', 'Jitrničky', 'Jitrničky aneb novinky', NULL, NULL, NULL, NULL, NULL, 0, 5, 1, 1, 1, 'weekly', 0.9, 1, 0),
(14, 9, 'chyby', 'Chyby', 'Hlášení chyb výpečkovského enginu', 'Errors', 'Reporting errors', NULL, NULL, NULL, 0, 0, 1, 1, 1, 'yearly', 0.1, 1, 0),
(15, 2, 'sponsors', 'Sponzoři', 'Naši sponzoři', 'Sponsors', 'Our sponsors', NULL, NULL, NULL, 0, 0, 1, 1, 1, 'yearly', 0.1, 1, 0),
(16, 13, 'portalusers', 'Uživatelé', 'Uživatelé portálu', 'Users', 'Portal Users', NULL, NULL, NULL, 0, 0, 1, 1, 1, 'yearly', 0.1, 1, 0);
...
(1, 'Tlačenka', 'Tlačenka aneb blog na Výpečkách', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', '10', 0, 10, 11),
(2, 'Výpečky', 'Naše logo', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 5, 1, 12),
(3, 'Portfolio', 'Portfolio našeho grafika', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 0, 2, 12),
(4, 'Fotogalerie', 'Fotografie z akcí', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 'scroll=10;smallwidth=150;smallheight=150;ismedium=false;width=800;height=600;numphotosingalerylist=3;photoinpage=false', 0, 11, 18),
(5, 'Jitrničky', 'Jitrničky aneb novinky na výpečkách', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', 'scroll=10;scrollpanel=5;', 0, 13, 2),
(6, 'Komiks', 'Komiks Kuba a Kuba', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '1', 0, 3, 13),
(7, 'Úvodní proslov', 'Úvodní slovo ke komiksům', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 5, 3, 1),
(8, 'Odkazy', 'Odkazy', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', '0', 0, 12, 14),
(9, 'Odkazy', NULL, NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 0, 12, 1),
(10, 'Jak žije Blahoš', 'Jak si žije Server Blahoš u nás ve sklepě', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 0, 8, 10),
(11, 'O Blahošovi', 'Úvodní text o Blahošovi', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 5, 8, 1),
(12, 'WebMail Výpeček', 'Přístup k Webmailovému klientu Výpeček', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 0, 7, 10),
(13, 'Sdílená data', 'Sdílená data pro potřeby Výpeček', NULL, NULL, NULL, NULL, 'rwc', 'r--', 'r--', 'rwc', '0', 0, 6, 10),
(14, 'Naše Data', 'Úvodní slovo ke zdíleným datů', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', '0', 0, 6, 1),
(15, 'Kniha návštěv', 'Kniha návštěv - nebojte se a napište nám', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', '10', 0, 9, 9),
(16, 'Chyby enginu', 'Chyby a opravy v Enginu Výpeček', NULL, NULL, NULL, NULL, 'rwc', 'rw-', '---', 'rwc', '0', 0, 14, 15),
(17, 'Můj účet', 'Nastavení mého účtu', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', '0', 0, 4, 4),
(18, 'Sponzoři', 'Naši sponzoři', NULL, NULL, NULL, NULL, 'rwc', 'rw-', 'r--', 'rwc', '0', 0, 15, 16),
(19, 'Uživatelé', 'Uživatelé na portálu', NULL, NULL, NULL, NULL, 'rwc', 'r--', '---', 'rwc', '20', 0, 16, 17);
...
(33, 5, '', 3, 'Další novinka', 'ggfd gdfg fdg df', NULL, NULL, NULL, NULL, 1237116725, 1),
...
CREATE TABLE IF NOT EXISTS `vypecky_photos` (
  ...
  KEY `id_galery` (`id_galery`),
  KEY `id_user` (`id_user`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1068 ;
...
(874, 'aki-ross-09.jpg', NULL, NULL, 'aki-ross-09.jpg', 1223290452, NULL, NULL, NULL, 0, 0, 57, 0),
(873, 'angelina-herbe7.jpg', NULL, NULL, 'angelina-herbe7.jpg', 1223289916, NULL, NULL, NULL, 0, 0, 57, 0),
(872, 'logo6.jpg', NULL, NULL, 'logo6.jpg', 1223289893, NULL, NULL, NULL, 0, 0, 57, 0),
(871, 'beech-tree7.jpg', NULL, NULL, 'beech-tree7.jpg', 1223289889, NULL, NULL, NULL, 0, 0, 57, 0),
(870, 'autumn8.jpg', NULL, NULL, 'autumn8.jpg', 1223289877, NULL, NULL, NULL, 0, 0, 57, 0),
(869, 'angel8.jpg', NULL, NULL, 'angel8.jpg', 1223289859, NULL, NULL, NULL, 0, 0, 57, 0),
(868, 'aki-ross-08.jpg', NULL, NULL, 'aki-ross-08.jpg', 1223289847, NULL, NULL, NULL, 0, 0, 57, 0),
(867, 'angelina-herbe6.jpg', NULL, NULL, 'angelina-herbe6.jpg', 1223289801, NULL, NULL, NULL, 0, 0, 57, 0),
(866, 'logo5.jpg', NULL, NULL, 'logo5.jpg', 1223289782, NULL, NULL, NULL, 0, 0, 57, 0),
(865, 'beech-tree6.jpg', NULL, NULL, 'beech-tree6.jpg', 1223289778, NULL, NULL, NULL, 0, 0, 57, 0),
(864, 'autumn7.jpg', NULL, NULL, 'autumn7.jpg', 1223289766, NULL, NULL, NULL, 0, 0, 57, 0),
(863, 'angel7.jpg', NULL, NULL, 'angel7.jpg', 1223289755, NULL, NULL, NULL, 0, 0, 57, 0),
(862, 'aki-ross-07.jpg', NULL, NULL, 'aki-ross-07.jpg', 1223289743, NULL, NULL, NULL, 0, 0, 57, 0),
(861, 'angelina-herbe5.jpg', NULL, NULL, 'angelina-herbe5.jpg', 1223289719, NULL, NULL, NULL, 0, 0, 57, 0),
(860, 'logo4.jpg', NULL, NULL, 'logo4.jpg', 1223289706, NULL, NULL, NULL, 0, 0, 57, 0),
(859, 'beech-tree5.jpg', NULL, NULL, 'beech-tree5.jpg', 1223289702, NULL, NULL, NULL, 0, 0, 57, 0),
(858, 'autumn6.jpg', NULL, NULL, 'autumn6.jpg', 1223289690, NULL, NULL, NULL, 0, 0, 57, 0),
(857, 'angel6.jpg', NULL, NULL, 'angel6.jpg', 1223289680, NULL, NULL, NULL, 0, 0, 57, 0),
(855, 'beech-tree4.jpg', NULL, NULL, 'beech-tree4.jpg', 1223289373, NULL, NULL, NULL, 0, 0, 57, 0),
(856, 'aki-ross-06.jpg', NULL, NULL, 'aki-ross-06.jpg', 1223289667, NULL, NULL, NULL, 0, 0, 57, 0),
(854, 'autumn5.jpg', NULL, NULL, 'autumn5.jpg', 1223289340, NULL, NULL, NULL, 0, 0, 57, 0),
(853, 'angel5.jpg', NULL, NULL, 'angel5.jpg', 1223289310, NULL, NULL, NULL, 0, 0, 57, 0),
(852, 'aki-ross-05.jpg', NULL, NULL, 'aki-ross-05.jpg', 1223289292, NULL, NULL, NULL, 0, 0, 57, 0),
(879, 'angelina-herbe8.jpg', NULL, NULL, 'angelina-herbe8.jpg', 1223290520, NULL, NULL, NULL, 0, 0, 57, 0),
(878, 'logo7.jpg', NULL, NULL, 'logo7.jpg', 1223290495, NULL, NULL, NULL, 0, 0, 57, 0),
(877, 'beech-tree8.jpg', NULL, NULL, 'beech-tree8.jpg', 1223290491, NULL, NULL, NULL, 0, 0, 57, 0),
(876, 'autumn9.jpg', NULL, NULL, 'autumn9.jpg', 1223290479, NULL, NULL, NULL, 0, 0, 57, 0),
(875, 'angel9.jpg', NULL, NULL, 'angel9.jpg', 1223290465, NULL, NULL, NULL, 0, 0, 57, 0),
...
(851, 'angelina-herbe4.jpg', NULL, NULL, 'angelina-herbe4.jpg', 1223287934, NULL, NULL, NULL, 0, 0, 57, 0),
(850, 'logo3.jpg', NULL, NULL, 'logo3.jpg', 1223287914, NULL, NULL, NULL, 0, 0, 57, 0),
(849, 'beech-tree3.jpg', NULL, NULL, 'beech-tree3.jpg', 1223287905, NULL, NULL, NULL, 0, 0, 57, 0),
(848, 'autumn4.jpg', NULL, NULL, 'autumn4.jpg', 1223287860, NULL, NULL, NULL, 0, 0, 57, 0),
(847, 'angel4.jpg', NULL, NULL, 'angel4.jpg', 1223287811, NULL, NULL, NULL, 0, 0, 57, 0),
(1003, 'leto.jpg', NULL, NULL, 'leto.jpg', 1223386786, NULL, NULL, NULL, 0, 0, 69, 0),
(1033, 'angel26.jpg', NULL, NULL, 'angel26.jpg', 1223734003, NULL, NULL, NULL, 0, 0, 72, 0),
(845, 'auto11.jpg', NULL, NULL, 'auto11.jpg', 1223287176, NULL, NULL, NULL, 0, 0, 58, 0),
(1035, 'beech-tree24.jpg', NULL, NULL, 'beech-tree24.jpg', 1223734042, NULL, NULL, NULL, 0, 0, 72, 0),
(1036, 'logo23.jpg', NULL, NULL, 'logo23.jpg', 1223734051, NULL, NULL, NULL, 0, 0, 72, 0),
(1037, 'angelina-herbe23.jpg', NULL, NULL, 'angelina-herbe23.jpg', 1223734068, NULL, NULL, NULL, 0, 0, 72, 0),
...
(896, 'beech-tree11.jpg', NULL, NULL, 'beech-tree11.jpg', 1223304749, NULL, NULL, NULL, 0, 0, 57, 0),
(895, 'autumn12.jpg', NULL, NULL, 'autumn12.jpg', 1223304725, NULL, NULL, NULL, 0, 0, 57, 0),
(894, 'angel12.jpg', NULL, NULL, 'angel12.jpg', 1223304698, NULL, NULL, NULL, 0, 0, 57, 0),
(893, 'aki-ross-013.jpg', NULL, NULL, 'aki-ross-013.jpg', 1223304667, NULL, NULL, NULL, 0, 0, 57, 0),
(892, 'aki-ross-012.jpg', NULL, NULL, 'aki-ross-012.jpg', 1223290722, NULL, NULL, NULL, 0, 0, 57, 0),
(891, 'angelina-herbe10.jpg', NULL, NULL, 'angelina-herbe10.jpg', 1223290721, NULL, NULL, NULL, 0, 0, 57, 0),
(890, 'logo9.jpg', NULL, NULL, 'logo9.jpg', 1223290695, NULL, NULL, NULL, 0, 0, 57, 0),
(889, 'beech-tree10.jpg', NULL, NULL, 'beech-tree10.jpg', 1223290686, NULL, NULL, NULL, 0, 0, 57, 0),
(888, 'autumn11.jpg', NULL, NULL, 'autumn11.jpg', 1223290667, NULL, NULL, NULL, 0, 0, 57, 0),
(887, 'angel11.jpg', NULL, NULL, 'angel11.jpg', 1223290652, NULL, NULL, NULL, 0, 0, 57, 0),
(886, 'aki-ross-011.jpg', NULL, NULL, 'aki-ross-011.jpg', 1223290624, NULL, NULL, NULL, 0, 0, 57, 0),
(885, 'angelina-herbe9.jpg', NULL, NULL, 'angelina-herbe9.jpg', 1223290611, NULL, NULL, NULL, 0, 0, 57, 0),
(884, 'logo8.jpg', NULL, NULL, 'logo8.jpg', 1223290594, NULL, NULL, NULL, 0, 0, 57, 0),
(883, 'beech-tree9.jpg', NULL, NULL, 'beech-tree9.jpg', 1223290590, NULL, NULL, NULL, 0, 0, 57, 0),
(882, 'autumn10.jpg', NULL, NULL, 'autumn10.jpg', 1223290578, NULL, NULL, NULL, 0, 0, 57, 0),
(881, 'angel10.jpg', NULL, NULL, 'angel10.jpg', 1223290560, NULL, NULL, NULL, 0, 0, 57, 0),
(880, 'aki-ross-010.jpg', NULL, NULL, 'aki-ross-010.jpg', 1223290540, NULL, NULL, NULL, 0, 0, 57, 0),
...
(897, 'logo10.jpg', NULL, NULL, 'logo10.jpg', 1223304753, NULL, NULL, NULL, 0, 0, 57, 0),
(898, 'angelina-herbe11.jpg', NULL, NULL, 'angelina-herbe11.jpg', 1223304767, NULL, NULL, NULL, 0, 0, 57, 0),
(899, 'aki-ross-014.jpg', NULL, NULL, 'aki-ross-014.jpg', 1223304874, NULL, NULL, NULL, 0, 0, 57, 0),
(900, 'angel13.jpg', NULL, NULL, 'angel13.jpg', 1223304892, NULL, NULL, NULL, 0, 0, 57, 0),
(901, 'autumn13.jpg', NULL, NULL, 'autumn13.jpg', 1223304909, NULL, NULL, NULL, 0, 0, 57, 0),
(902, 'beech-tree12.jpg', NULL, NULL, 'beech-tree12.jpg', 1223304931, NULL, NULL, NULL, 0, 0, 57, 0),
(903, 'logo11.jpg', NULL, NULL, 'logo11.jpg', 1223304936, NULL, NULL, NULL, 0, 0, 57, 0),
(904, 'angelina-herbe12.jpg', NULL, NULL, 'angelina-herbe12.jpg', 1223304952, NULL, NULL, NULL, 0, 0, 57, 0),
(905, 'aki-ross-015.jpg', NULL, NULL, 'aki-ross-015.jpg', 1223305982, NULL, NULL, NULL, 0, 0, 57, 0),
(906, 'angel14.jpg', NULL, NULL, 'angel14.jpg', 1223305996, NULL, NULL, NULL, 0, 0, 57, 0),
(907, 'autumn14.jpg', NULL, NULL, 'autumn14.jpg', 1223306012, NULL, NULL, NULL, 0, 0, 57, 0),
(908, 'beech-tree13.jpg', NULL, NULL, 'beech-tree13.jpg', 1223306024, NULL, NULL, NULL, 0, 0, 57, 0),
(909, 'logo12.jpg', NULL, NULL, 'logo12.jpg', 1223306028, NULL, NULL, NULL, 0, 0, 57, 0),
(910, 'angelina-herbe13.jpg', NULL, NULL, 'angelina-herbe13.jpg', 1223306040, NULL, NULL, NULL, 0, 0, 57, 0),
(911, 'aki-ross-016.jpg', NULL, NULL, 'aki-ross-016.jpg', 1223307414, NULL, NULL, NULL, 0, 0, 57, 0),
(912, 'aki-ross-017.jpg', NULL, NULL, 'aki-ross-017.jpg', 1223307445, NULL, NULL, NULL, 0, 0, 57, 0),
(913, 'angel15.jpg', NULL, NULL, 'angel15.jpg', 1223307464, NULL, NULL, NULL, 0, 0, 57, 0),
(914, 'angel16.jpg', NULL, NULL, 'angel16.jpg', 1223307480, NULL, NULL, NULL, 0, 0, 57, 0),
(915, 'autumn15.jpg', NULL, NULL, 'autumn15.jpg', 1223307497, NULL, NULL, NULL, 0, 0, 57, 0),
(916, 'autumn16.jpg', NULL, NULL, 'autumn16.jpg', 1223307508, NULL, NULL, NULL, 0, 0, 57, 0),
(917, 'beech-tree14.jpg', NULL, NULL, 'beech-tree14.jpg', 1223307521, NULL, NULL, NULL, 0, 0, 57, 0),
(918, 'beech-tree15.jpg', NULL, NULL, 'beech-tree15.jpg', 1223307544, NULL, NULL, NULL, 0, 0, 57, 0),
(919, 'logo13.jpg', NULL, NULL, 'logo13.jpg', 1223307552, NULL, NULL, NULL, 0, 0, 57, 0),
(920, 'logo14.jpg', NULL, NULL, 'logo14.jpg', 1223307562, NULL, NULL, NULL, 0, 0, 57, 0),
(921, 'angelina-herbe14.jpg', NULL, NULL, 'angelina-herbe14.jpg', 1223307593, NULL, NULL, NULL, 0, 0, 57, 0),
(922, 'angelina-herbe15.jpg', NULL, NULL, 'angelina-herbe15.jpg', 1223307631, NULL, NULL, NULL, 0, 0, 57, 0),
(923, 'aki-ross-018.jpg', NULL, NULL, 'aki-ross-018.jpg', 1223307681, NULL, NULL, NULL, 0, 0, 57, 0),
(924, 'angel17.jpg', NULL, NULL, 'angel17.jpg', 1223307693, NULL, NULL, NULL, 0, 0, 57, 0),
(925, 'autumn17.jpg', NULL, NULL, 'autumn17.jpg', 1223307704, NULL, NULL, NULL, 0, 0, 57, 0),
(926, 'beech-tree16.jpg', NULL, NULL, 'beech-tree16.jpg', 1223307716, NULL, NULL, NULL, 0, 0, 57, 0),
(927, 'logo15.jpg', NULL, NULL, 'logo15.jpg', 1223307720, NULL, NULL, NULL, 0, 0, 57, 0),
(928, 'angelina-herbe16.jpg', NULL, NULL, 'angelina-herbe16.jpg', 1223307731, NULL, NULL, NULL, 0, 0, 57, 0),
(929, 'aki-ross-019.jpg', NULL, NULL, 'aki-ross-019.jpg', 1223307826, NULL, NULL, NULL, 0, 0, 57, 0),
(930, 'angel18.jpg', NULL, NULL, 'angel18.jpg', 1223307838, NULL, NULL, NULL, 0, 0, 57, 0),
(931, 'autumn18.jpg', NULL, NULL, 'autumn18.jpg', 1223307849, NULL, NULL, NULL, 0, 0, 57, 0),
(932, 'beech-tree17.jpg', NULL, NULL, 'beech-tree17.jpg', 1223307862, NULL, NULL, NULL, 0, 0, 57, 0),
(933, 'logo16.jpg', NULL, NULL, 'logo16.jpg', 1223307867, NULL, NULL, NULL, 0, 0, 57, 0),
(934, 'angelina-herbe17.jpg', NULL, NULL, 'angelina-herbe17.jpg', 1223307888, NULL, NULL, NULL, 0, 0, 57, 0),
(935, 'aki-ross-020.jpg', NULL, NULL, 'aki-ross-020.jpg', 1223308061, NULL, NULL, NULL, 0, 0, 57, 0),
(936, 'angel19.jpg', NULL, NULL, 'angel19.jpg', 1223308074, NULL, NULL, NULL, 0, 0, 57, 0),
(937, 'autumn19.jpg', NULL, NULL, 'autumn19.jpg', 1223308086, NULL, NULL, NULL, 0, 0, 57, 0),
(938, 'beech-tree18.jpg', NULL, NULL, 'beech-tree18.jpg', 1223308104, NULL, NULL, NULL, 0, 0, 57, 0),
(939, 'aki-ross-021.jpg', NULL, NULL, 'aki-ross-021.jpg', 1223308118, NULL, NULL, NULL, 0, 0, 57, 0),
(940, 'logo17.jpg', NULL, NULL, 'logo17.jpg', 1223308124, NULL, NULL, NULL, 0, 0, 57, 0),
(941, 'angel20.jpg', NULL, NULL, 'angel20.jpg', 1223308138, NULL, NULL, NULL, 0, 0, 57, 0),
(942, 'angelina-herbe18.jpg', NULL, NULL, 'angelina-herbe18.jpg', 1223308152, NULL, NULL, NULL, 0, 0, 57, 0),
(943, 'autumn20.jpg', NULL, NULL, 'autumn20.jpg', 1223308164, NULL, NULL, NULL, 0, 0, 57, 0),
(944, 'aki-ross-022.jpg', NULL, NULL, 'aki-ross-022.jpg', 1223308271, NULL, NULL, NULL, 0, 0, 57, 0),
(945, 'angel21.jpg', NULL, NULL, 'angel21.jpg', 1223308291, NULL, NULL, NULL, 0, 0, 57, 0),
(946, 'autumn21.jpg', NULL, NULL, 'autumn21.jpg', 1223308307, NULL, NULL, NULL, 0, 0, 57, 0),
(947, 'beech-tree19.jpg', NULL, NULL, 'beech-tree19.jpg', 1223308337, NULL, NULL, NULL, 0, 0, 57, 0),
(948, 'logo18.jpg', NULL, NULL, 'logo18.jpg', 1223308347, NULL, NULL, NULL, 0, 0, 57, 0),
(949, 'angelina-herbe19.jpg', NULL, NULL, 'angelina-herbe19.jpg', 1223308386, NULL, NULL, NULL, 0, 0, 57, 0),
(950, 'aki-ross-023.jpg', NULL, NULL, 'aki-ross-023.jpg', 1223312918, NULL, NULL, NULL, 0, 0, 57, 0),
(951, 'angel22.jpg', NULL, NULL, 'angel22.jpg', 1223312945, NULL, NULL, NULL, 0, 0, 57, 0),
(952, 'autumn22.jpg', NULL, NULL, 'autumn22.jpg', 1223312957, NULL, NULL, NULL, 0, 0, 57, 0),
(953, 'beech-tree20.jpg', NULL, NULL, 'beech-tree20.jpg', 1223312970, NULL, NULL, NULL, 0, 0, 57, 0),
(954, 'logo19.jpg', NULL, NULL, 'logo19.jpg', 1223312977, NULL, NULL, NULL, 0, 0, 57, 0),
(955, 'angelina-herbe20.jpg', NULL, NULL, 'angelina-herbe20.jpg', 1223312995, NULL, NULL, NULL, 0, 0, 57, 0),
(956, 'aki-ross-024.jpg', NULL, NULL, 'aki-ross-024.jpg', 1223313067, NULL, NULL, NULL, 0, 0, 57, 0),
(957, 'angel23.jpg', NULL, NULL, 'angel23.jpg', 1223313086, NULL, NULL, NULL, 0, 0, 57, 0),
(958, 'autumn23.jpg', NULL, NULL, 'autumn23.jpg', 1223313114, NULL, NULL, NULL, 0, 0, 57, 0),
(959, 'beech-tree21.jpg', NULL, NULL, 'beech-tree21.jpg', 1223313141, NULL, NULL, NULL, 0, 0, 57, 0),
(960, 'logo20.jpg', NULL, NULL, 'logo20.jpg', 1223313149, NULL, NULL, NULL, 0, 0, 57, 0),
(961, 'angelina-herbe21.jpg', NULL, NULL, 'angelina-herbe21.jpg', 1223313178, NULL, NULL, NULL, 0, 0, 57, 0),
(962, 'aki-ross-025.jpg', NULL, NULL, 'aki-ross-025.jpg', 1223314592, NULL, NULL, NULL, 0, 0, 57, 0),
(963, 'angel24.jpg', NULL, NULL, 'angel24.jpg', 1223314617, NULL, NULL, NULL, 0, 0, 57, 0),
(964, 'aki-ross-026.jpg', NULL, NULL, 'aki-ross-026.jpg', 1223314628, NULL, NULL, NULL, 0, 0, 57, 0),
(965, 'autumn24.jpg', NULL, NULL, 'autumn24.jpg', 1223314645, NULL, NULL, NULL, 0, 0, 57, 0),
(966, 'angel25.jpg', NULL, NULL, 'angel25.jpg', 1223314652, NULL, NULL, NULL, 0, 0, 57, 0),
(967, 'beech-tree22.jpg', NULL, NULL, 'beech-tree22.jpg', 1223314675, NULL, NULL, NULL, 0, 0, 57, 0),
(968, 'autumn25.jpg', NULL, NULL, 'autumn25.jpg', 1223314677, NULL, NULL, NULL, 0, 0, 57, 0),
(969, 'logo21.jpg', NULL, NULL, 'logo21.jpg', 1223314692, NULL, NULL, NULL, 0, 0, 57, 0),
(970, 'beech-tree23.jpg', NULL, NULL, 'beech-tree23.jpg', 1223314699, NULL, NULL, NULL, 0, 0, 57, 0),
(971, 'angelina-herbe22.jpg', NULL, NULL, 'angelina-herbe22.jpg', 1223314709, NULL, NULL, NULL, 0, 0, 57, 0),
(972, 'logo22.jpg', NULL, NULL, 'logo22.jpg', 1223314709, NULL, NULL, NULL, 0, 0, 57, 0),
(1039, 'angel27.jpg', NULL, NULL, 'angel27.jpg', 1223742869, NULL, NULL, NULL, 0, 0, 73, 0),
(1040, 'autumn27.jpg', NULL, NULL, 'autumn27.jpg', 1223742890, NULL, NULL, NULL, 0, 0, 73, 0),
(1013, '0001-angelina-jolie-011.jpg', NULL, NULL, '0001-angelina-jolie-011.jpg', 1223655847, NULL, NULL, NULL, 0, 0, 54, 0),
(1038, 'aki-ross-027.jpg', NULL, NULL, 'aki-ross-027.jpg', 1223742851, NULL, NULL, NULL, 0, 0, 73, 0),
(1015, 'angelina-jolie-wallpaper-1600x1200.jpg', NULL, NULL, 'angelina-jolie-wallpaper-1600x1200.jpg', 1223655889, NULL, NULL, NULL, 0, 0, 54, 0),
(1016, 'angelina-jolie-151.jpg', NULL, NULL, 'angelina-jolie-151.jpg', 1223655921, NULL, NULL, NULL, 0, 0, 54, 0),
(1017, 'angelina-jolie58.jpg', NULL, NULL, 'angelina-jolie58.jpg', 1223655944, NULL, NULL, NULL, 0, 0, 54, 0),
(1018, '142722612.jpg', NULL, NULL, '142722612.jpg', 1223656002, NULL, NULL, NULL, 0, 0, 54, 0),
(1019, 'angelina-jolie-1600x1200-012.jpg', NULL, NULL, 'angelina-jolie-1600x1200-012.jpg', 1223656025, NULL, NULL, NULL, 0, 0, 54, 0),
(1020, '0001-angelina-jolie-012.jpg', NULL, NULL, '0001-angelina-jolie-012.jpg', 1223656051, NULL, NULL, NULL, 0, 0, 54, 0),
(1034, 'autumn26.jpg', NULL, NULL, 'autumn26.jpg', 1223734021, NULL, NULL, NULL, 0, 0, 72, 0),
(1022, 'angelina-jolie-wallpaper-1600x12002.jpg', NULL, NULL, 'angelina-jolie-wallpaper-1600x12002.jpg', 1223656101, NULL, NULL, NULL, 0, 0, 54, 0),
(1004, '142722611.jpg', NULL, NULL, '142722611.jpg', 1223557915, NULL, NULL, NULL, 0, 0, 58, 0),
(1005, 'angelina-jolie-1600x1200-01.jpg', NULL, NULL, 'angelina-jolie-1600x1200-01.jpg', 1223557944, NULL, NULL, NULL, 0, 0, 58, 0),
(1006, '0001-angelina-jolie-011.jpg', NULL, NULL, '0001-angelina-jolie-011.jpg', 1223557962, NULL, NULL, NULL, 0, 0, 58, 0),
(1007, 'angelina-jolie-886.jpg', NULL, NULL, 'angelina-jolie-886.jpg', 1223557980, NULL, NULL, NULL, 0, 0, 58, 0),
(1008, 'angelina-jolie-wallpaper-1600x12001.jpg', NULL, NULL, 'angelina-jolie-wallpaper-1600x12001.jpg', 1223558005, NULL, NULL, NULL, 0, 0, 58, 0),
(1009, 'angelina-jolie-1512.jpg', NULL, NULL, 'angelina-jolie-1512.jpg', 1223558024, NULL, NULL, NULL, 0, 0, 58, 0),
(1010, 'angelina-jolie582.jpg', NULL, NULL, 'angelina-jolie582.jpg', 1223558051, NULL, NULL, NULL, 0, 0, 58, 0),
(1032, 'aki-ross-04.jpg', NULL, NULL, 'aki-ross-04.jpg', 1223733984, NULL, NULL, NULL, 0, 0, 72, 0),
(1041, 'beech-tree25.jpg', NULL, NULL, 'beech-tree25.jpg', 1223742911, NULL, NULL, NULL, 0, 0, 73, 0),
(1042, 'logo24.jpg', NULL, NULL, 'logo24.jpg', 1223742922, NULL, NULL, NULL, 0, 0, 73, 0),
(1043, 'angelina-herbe24.jpg', NULL, NULL, 'angelina-herbe24.jpg', 1223742945, NULL, NULL, NULL, 0, 0, 73, 0),
(1044, 'aki-ross-028.jpg', NULL, NULL, 'aki-ross-028.jpg', 1223743054, NULL, NULL, NULL, 0, 0, 73, 0),
(1045, 'angel28.jpg', NULL, NULL, 'angel28.jpg', 1223743075, NULL, NULL, NULL, 0, 0, 73, 0),
(1046, 'autumn28.jpg', NULL, NULL, 'autumn28.jpg', 1223743091, NULL, NULL, NULL, 0, 0, 73, 0),
(1047, 'beech-tree26.jpg', NULL, NULL, 'beech-tree26.jpg', 1223743107, NULL, NULL, NULL, 0, 0, 73, 0),
(1048, 'logo25.jpg', NULL, NULL, 'logo25.jpg', 1223743116, NULL, NULL, NULL, 0, 0, 73, 0),
(1049, 'angelina-herbe25.jpg', NULL, NULL, 'angelina-herbe25.jpg', 1223743133, NULL, NULL, NULL, 0, 0, 73, 0),
(1050, 'aki-ross-029.jpg', NULL, NULL, 'aki-ross-029.jpg', 1223743194, NULL, NULL, NULL, 0, 0, 73, 0),
(1051, 'angel29.jpg', NULL, NULL, 'angel29.jpg', 1223743224, NULL, NULL, NULL, 0, 0, 73, 0),
(1052, 'autumn29.jpg', NULL, NULL, 'autumn29.jpg', 1223743244, NULL, NULL, NULL, 0, 0, 73, 0),
(1053, 'beech-tree27.jpg', NULL, NULL, 'beech-tree27.jpg', 1223743267, NULL, NULL, NULL, 0, 0, 73, 0),
(1054, 'logo26.jpg', NULL, NULL, 'logo26.jpg', 1223743276, NULL, NULL, NULL, 0, 0, 73, 0),
(1055, 'angelina-herbe26.jpg', NULL, NULL, 'angelina-herbe26.jpg', 1223743294, NULL, NULL, NULL, 0, 0, 73, 0),
(1056, 'aki-ross-030.jpg', NULL, NULL, 'aki-ross-030.jpg', 1227695541, NULL, NULL, NULL, 0, 0, 72, 0),
(1057, 'angel30.jpg', NULL, NULL, 'angel30.jpg', 1227695558, NULL, NULL, NULL, 0, 0, 72, 0),
(1058, 'autumn30.jpg', NULL, NULL, 'autumn30.jpg', 1227695574, NULL, NULL, NULL, 0, 0, 72, 0),
(1059, 'beech-tree28.jpg', NULL, NULL, 'beech-tree28.jpg', 1227695590, NULL, NULL, NULL, 0, 0, 72, 0),
(1060, 'logo27.jpg', NULL, NULL, 'logo27.jpg', 1227695600, NULL, NULL, NULL, 0, 0, 72, 0),
(1061, 'angelina-herbe27.jpg', NULL, NULL, 'angelina-herbe27.jpg', 1227695620, NULL, NULL, NULL, 0, 0, 72, 0),
(1062, 'aki-ross-031.jpg', NULL, NULL, 'aki-ross-031.jpg', 1227695784, NULL, NULL, NULL, 0, 0, 72, 0),
(1063, 'angel31.jpg', NULL, NULL, 'angel31.jpg', 1227695800, NULL, NULL, NULL, 0, 0, 72, 0),
(1064, 'autumn31.jpg', NULL, NULL, 'autumn31.jpg', 1227695816, NULL, NULL, NULL, 0, 0, 72, 0),
(1065, 'beech-tree29.jpg', NULL, NULL, 'beech-tree29.jpg', 1227695832, NULL, NULL, NULL, 0, 0, 72, 0),
(1066, 'logo28.jpg', NULL, NULL, 'logo28.jpg', 1227695841, NULL, NULL, NULL, 0, 0, 72, 0),
(1067, 'angelina-herbe28.jpg', NULL, NULL, 'angelina-herbe28.jpg', 1227695858, NULL, NULL, NULL, 0, 0, 72, 0);
...
(54, 'pokusna-galerie-testttttttttttt', 'Pokusná galerie s různýma fotkama', 'Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text ', NULL, NULL, NULL, NULL, 1223244000, 21, 3),
(57, 'nova-galerka', 'nová galerkaaaaa', NULL, NULL, NULL, NULL, NULL, 1223244000, 21, 3),
(58, 'nova-galerka2', 'nová galerkaaaaa', NULL, NULL, NULL, NULL, NULL, 1223244000, 21, 3),
(72, '..nova...', 'nova', NULL, NULL, NULL, NULL, NULL, 1223676000, 21, 3),
(73, '..pokus..', 'pokus', NULL, NULL, NULL, NULL, NULL, 1223676000, 21, 3),
(69, 'nova-galerka-2', 'nová galerka', NULL, NULL, NULL, NULL, NULL, 1223244000, 21, 3),
...
(7, 0, '<p>Tak tady žije blahoš. Náš server, který je schován ve sklepě a tiše tu šlape už dva roky. Ani se radši neptejte co je to za stroj. Je to Pentuin2 350Mhz s 384 MB RAM. To koukáte co? No jo stačí <a title="Gentoo linux" href="http://www.getoo.org" target="_blank">Gentoo linux</a>, správné nastavení je je to. :-) Pokus<img style="float: left;" title="10720-stamp.jpg" src="data/userimages/10720-stamp.jpg" alt="10720-stamp.jpg" width="160" height="128" /><img style="float: right;" title="gentoo-logo.jpg" src="data/userimages/gentoo-logo.jpg" alt="gentoo-logo.jpg" width="150" height="150" /></p>', 1232236086, '<p>Blahos is our server, whitch hosting domain vypecky.info and other. Have fun!</p>', NULL),
(6, 11, '<p><img title="gentoo-logo.jpg" src="data/userimages/gentoo-logo.jpg" alt="gentoo-logo.jpg" width="150" height="150" /></p>\r\n<p>Tak tady žije blahoš. Náš server, který je schován ve sklepě a tiše tu šlape už dva roky. Ani se radši neptejte co je to za stroj. Je to Pentuin2 350Mhz s 384 MB RAM. To koukáte co? No jo stačí <a title="Gentoo linux" href="http://www.getoo.org" target="_blank">Gentoo linux</a>, správné nastavení je je to. :-) pokuss<img style="float: left;" title="10720-stamp.jpg" src="data/userimages/10720-stamp.jpg" alt="10720-stamp.jpg" width="160" height="128" /><img style="float: right;" title="gentoo-logo.jpg" src="data/userimages/gentoo-logo.jpg" alt="gentoo-logo.jpg" width="150" height="150" /></p>', 1232296985, '<p>Blahos is our server, whitch hosting domain vypecky.info and other. Have fun!</p>', NULL);
...
(28, 11, 11, 3, 'images.zip', 1927673, 1222599867);
...
(49, 11, 11, 3, '10720-stamp.jpg', 160, 128, 3380, 1226622558),
(50, 11, 11, 3, 'gentoo-logo.jpg', 150, 150, 4400, 1226622606);
