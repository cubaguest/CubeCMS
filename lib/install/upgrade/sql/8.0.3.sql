...
UPDATE `cubecms_global_config` SET `values`='cs;en;de;ru;sk;au;us;da;es;pl;lv;is;sl;et;lt;hu;sv', `callback_func`='Install_Core::updateIsntaledLangs' WHERE `key` = 'APP_LANGS';
