...
class JsPlugin_TinyMce extends JsPlugin {
   ...
   private $advancedSimpleParams = array(
           ...
           'theme_advanced_buttons1' => 'bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,search,|,link,unlink,|,undo,redo,code,|,image,media',
