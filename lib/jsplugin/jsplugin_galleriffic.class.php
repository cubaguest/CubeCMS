...
class JsPlugin_Galleriffic extends JsPlugin {
	protected function initJsPlugin() {
      $this->setJsPluginName('jquerygalleriffic');
	}
	
	protected function setFiles() {
      $jquery = new JsPlugin_JQuery();
      $jquery->addPluginOpacityRollOver();
      $this->addDependJsPlugin($jquery);
//		Přidání css stylu
		$this->addFile(new JsPlugin_CssFile('galleriffic.css'));
		//		Přidání js soubrů pluginu
		$this->addFile(new JsPlugin_JsFile("jquery.galleriffic.js"));
	}
}
?>