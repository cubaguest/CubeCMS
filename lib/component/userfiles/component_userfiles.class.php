 ...
 * @version    	$Id: eplugin_userfiles.class.php 642 2009-08-18 09:23:18Z jakub $ VVE3.9.4 $Revision: 642 $
 * @author        $Author: jakub $ $Date: 2009-08-18 11:23:18 +0200 (Tue, 18 Aug 2009) $
 *                $LastChangedBy: jakub $ $LastChangedDate: 2009-08-18 11:23:18 +0200 (Tue, 18 Aug 2009) $
...
//      $this->deleteUserFile($ajaxObj->getParam('idFile'));
   ...
   public function mainView() {
      ...
      // šablona pro obrázky
      $this->template()->fileTpl = new Template_Component($this->link());
      $this->template()->fileTpl->addTplFile("userfiles_detail.phtml");
      $this->template()->addCssFile("style_userfiles.css");
