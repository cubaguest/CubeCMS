...
class Component_TinyMCE_Settings_Advanced extends Component_TinyMCE_Settings {
   ...
   protected $defaultSettings = array(
      ...
      'PHPSESSID' => null,
      'cid' => null,
      'extended_valid_elements' => 'td[*],div[*],code[class],iframe[src|width|height|align|frameborder|scrolling|allowfullscreen],article[class|id],aside[class|id],figure[class|id]', // tady se musí upravit, protože tohle je nepřípustné kvůli atributům a XSS
      'forced_root_block' => 'p',
