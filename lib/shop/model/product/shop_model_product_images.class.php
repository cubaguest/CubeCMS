...
class Shop_Model_Product_Images extends Model_ORM_Ordered {
...
class Shop_Model_Product_Images_Record extends Model_ORM_Ordered_Record {

   public function getUrl()
   {
      return Shop_Tools::getProductImagesDir(true) . $this->{Shop_Model_Product_Images::COLUMN_ID_PRODUCT}
              . '/' . $this->{Shop_Model_Product_Images::COLUMN_ID} . '.' . $this->{Shop_Model_Product_Images::COLUMN_TYPE};
   }

   public function getPath()
   {
      return Shop_Tools::getProductImagesDir(false) . $this->{Shop_Model_Product_Images::COLUMN_ID_PRODUCT}
              . DIRECTORY_SEPARATOR . $this->{Shop_Model_Product_Images::COLUMN_ID} . '.' . $this->{Shop_Model_Product_Images::COLUMN_TYPE};
   }
   ...
   {
      $file = new File_Image($this->{Shop_Model_Product_Images::COLUMN_ID} . '.' . $this->{Shop_Model_Product_Images::COLUMN_TYPE}, 
              Shop_Tools::getProductImagesDir(false) . $this->{Shop_Model_Product_Images::COLUMN_ID_PRODUCT}
              . DIRECTORY_SEPARATOR);
      return $file;
   }
   ...
   {
      $img = new File_Image($this->{Shop_Model_Product_Images::COLUMN_ID} . '.' . $this->{Shop_Model_Product_Images::COLUMN_TYPE}, 
              Shop_Tools::getProductImagesDir(false) . $this->{Shop_Model_Product_Images::COLUMN_ID_PRODUCT}
              . DIRECTORY_SEPARATOR);
      if($img->exist()){
         $img->delete();
   ...
   {
      return $this->{Shop_Model_Product_Images::COLUMN_IS_TITLE} == true;
   }
