 ...
 * @author			$Author: jakub $ $Date: 2009-05-29 07:14:39 +0000 (Pá, 29 kvě 2009) $
 *						$LastChangedBy: jakub $ $LastChangedDate: 2009-05-29 07:14:39 +0000 (Pá, 29 kvě 2009) $
...
//   const COLUMN_ITEM_PRIORITY 		= 'priority';
   ...
   public function controller() {
      ...
      ->colums(array(Model_Category::COLUMN_CAT_LABEL => "IFNULL(cat."
            .Model_Category::COLUMN_CAT_LABEL_ORIG.'_'.Locale::getLang().", cat."
            .Model_Category::COLUMN_CAT_LABEL_ORIG.'_'.Locale::getDefaultLang().")",
            Model_Category::COLUMN_CAT_ID, Model_Category::COLUMN_CAT_ALT => "IFNULL(cat."
            .Model_Category::COLUMN_CAT_ALT_ORIG.'_'.Locale::getLang().", cat."
            .Model_Category::COLUMN_CAT_ALT_ORIG.'_'.Locale::getDefaultLang().")"))

      ->join(array('sec'=>$this->tablesSections),
         array(Model_Sections::COLUMN_SEC_ID, 'cat' => Model_Category::COLUMN_CAT_SEC_ID), null,
         array(Model_Sections::COLUMN_SEC_ID,
            Model_Sections::COLUMN_SEC_LABEL => "IFNULL(sec.".Model_Sections::COLUMN_SEC_LABEL_ORIG.'_'
            .Locale::getLang().", sec.".Model_Sections::COLUMN_SEC_LABEL_ORIG.'_'.Locale::getDefaultLang().")",
            Model_Sections::COLUMN_SEC_ALT => "IFNULL(sec.".Model_Sections::COLUMN_SEC_ALT_ORIG.'_'
            .Locale::getLang().", sec.".Model_Sections::COLUMN_SEC_ALT_ORIG.'_'.Locale::getDefaultLang().")"))
      ->join(array("item" => $this->tablesItems),
         array('cat' =>Model_Category::COLUMN_CAT_ID, Model_Module::COLUMN_ITEM_CAT_ID))
      ->where("cat.".Model_Category::COLUMN_CAT_ACTIVE, (int)true)
      ->where("cat.".Model_Category::COLUMN_CAT_SHOW_IN_MENU, (int)true)
      ->group("cat.".Model_Category::COLUMN_CAT_ID)
      ->order("sec.".Model_Sections::COLUMN_SEC_PRIORITY, Db::ORDER_DESC)
      ->order(Model_Sections::COLUMN_SEC_LABEL)
      ->order("cat.".Model_Category::COLUMN_CAT_PRIORITY, Db::ORDER_DESC)
      ->order(Model_Category::COLUMN_CAT_LABEL);

      if(!$this->auth()->isLogin()){
         $menuSelect->where("cat.".Model_Category::COLUMN_CAT_SHOW_WHEN_LOGIN_ONLY, (int)false);
      }
