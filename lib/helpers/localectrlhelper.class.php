...
class LocaleCtrlHelper extends CtrlHelper {
	 ...
	 */
	public function generateArray($elements, $values = null, $alternativeValues = null) {
		$returnArray = array();
	 ...
	 */
	public function postsToArray($postsArray, $postPrefix = null, $encodeSpecialChars = true, $decodeSpecialChars = false, $withPrefix = false){
		$returnArray = array();
