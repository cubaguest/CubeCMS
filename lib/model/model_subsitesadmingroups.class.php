...
class Model_SubSitesAdminGroups extends Model_ORM {
/**
 * Název tabulky s uživateli
 */
   const DB_TABLE = 'sub_sites_admin_groups';
   ...
   protected function  _initTable() {
      if(VVE_GLOBAL_TABLES_PREFIX != null) {
         $this->setTableName(VVE_GLOBAL_TABLES_PREFIX.self::DB_TABLE, 't_ss_a_g', false);
      } else {
         $this->setTableName(self::DB_TABLE, 't_ss_a_g');
      }
      ...
      $this->addForeignKey(self::COLUMN_ID_SITE, 'Model_SubSites', Model_SubSites::COLUMN_ID);
