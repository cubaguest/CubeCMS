...
//		Scrolovátka
		...
		$count = $this->getDb()->fetchObject($sqlCount->from(array("news"=>$this->getModule()->getDbTable()), array("count"=>"COUNT(*)")));
		$scroll->setCountAllRecords($count->count);	

		$sqlSelect = $sqlSelect->limit($scroll->getStartRecord(), $scroll->getCountRecords())
