...
class Eplugin {
	 ...
	 *
	 */
	function __construct(Db $dbConnector, Module $module, Rights $rights, Messages $errors, Messages $info)
	{
		$this->module = $module;
...
//		echo $this->templateFile;
	...
	public function scroll(){
		return new Scroll($this->getDb(), $this->getModule(), $this->rights, $this->errMsg, $this->infoMsg);
	}
	...
	public function changes() {
		return new Changes($this->getDb(), $this->getModule(), $this->rights, $this->errMsg, $this->infoMsg);
	}
	...
	public function userfiles() {
		return new UserFiles($this->getDb(), $this->getModule(), $this->rights, $this->errMsg, $this->infoMsg);
	}
	...
	public function userimages() {
		return new UserImages($this->getDb(), $this->getModule(), $this->rights, $this->errMsg, $this->infoMsg);
	}
