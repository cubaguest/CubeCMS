...
class Files {
	...
	/**
	 * Metoda překopíruje zadaný soubor do zadaného adresáře, popřípadě vytvoří nové jméno souboru
	 * //TODO not implemented
	 * @param string -- adresář, odkud se soubor kopŕuje
	 * @param string -- název souboru
	 * @param string -- adresář, kam se má soubor nakopírovat
	 */
	public function copy($srcFile, $dstDir) {
		;
	}
