...
//		bindtextdomain($this->getModule()->getName(), '.'.DIRECTORY_SEPARATOR.AppCore::MODULES_DIR.DIRECTORY_SEPARATOR.$this->getModule()->getName().DIRECTORY_SEPARATOR."locales");
//		textdomain($this->getModule()->getName()); 
...
//			}
		return new Eplugin($this->getDb(),$this->getModule(), $this->getRights(), $this->getSysConfig());
